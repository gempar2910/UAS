...
<div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <div class="mb-6 text-center">
            ...
            <h2 class="text-2xl font-semibold">Sign in as Mahasiswa</h2>
            <p class="text-gray-500 text-sm">Silahkan login menggunakan email institusi UNTAR</p>
        </div>
        ...
        <div class="text-center mt-4">
            <p class="text-gray-600 text-sm">Belum punya akun? 
                <a href="{{ route('register.mahasiswa') }}" class="text-red-600 font-semibold">Register</a>
            </p>
        </div>
    </div>
</div>
